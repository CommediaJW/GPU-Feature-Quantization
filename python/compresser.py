...
if __name__ == "__main__":
    th.ops.load_library("./build/libbifeat.so")
    th.manual_seed(1)
    compresser = Compresser("sq", 1, 12)

    features = th.randn(5000, 128)
    ...
    print(features.abs().mean(), (decompressed_features -
                                  features.to(decompress_device)).abs().mean())
